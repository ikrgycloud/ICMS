...
from migrations import v0008_category_based_fees
from migrations import v0009_backfill_fee_invoice_heads
from migrations import v0010_classify_legacy_fee_invoices
...
MIGRATIONS.append(v0008_category_based_fees)
MIGRATIONS.append(v0009_backfill_fee_invoice_heads)
MIGRATIONS.append(v0010_classify_legacy_fee_invoices)

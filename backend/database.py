...
DEMO_USERNAMES = {
    ...
    34: "security", 35: "front_office", 36: "25ECE072", 37: "parent",
...
def seed():
    ...
    try:
        ...
        # Keep the student demo account aligned with the named portal profile.
        # This also upgrades databases created before the roll-number login was
        # introduced, where this account was named simply "student".
        student_portal = s.get(User, "user_36")
        if student_portal:
            student_portal.username = DEMO_USERNAMES[36]
            student_person = s.get(Person, student_portal.person_id)
            if student_person:
                student_person.name = "Nisha Mehta"
                student_person.email = "25ece072@icms.edu"

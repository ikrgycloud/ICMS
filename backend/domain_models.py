...
class TransportVehicle(Base):
    ...
    vehicle_type = Column(String, default="BUS")
...
class TransportDriver(Base):
    ...
    vehicle_id = Column(String, ForeignKey("transport_vehicles.id"), nullable=True, unique=True)
    created_at = Column(DateTime, default=datetime.utcnow)
    updated_at = Column(DateTime, default=datetime.utcnow, onupdate=datetime.utcnow)
...
class TransportRequest(Base):
    ...
    tenant_id = Column(String, index=True)
    student_id = Column(String, ForeignKey("students.id"), index=True)
    route_id = Column(String, ForeignKey("transport_routes.id"))
    pickup_stop_id = Column(String, ForeignKey("transport_stops.id"))
    drop_stop_id = Column(String, ForeignKey("transport_stops.id"))
...
class TransportAllocation(Base):
    ...
    pickup_stop_id = Column(String, ForeignKey("transport_stops.id"))
    drop_stop_id = Column(String, ForeignKey("transport_stops.id"))
    vehicle_id = Column(String, ForeignKey("transport_vehicles.id"))
    driver_id = Column(String, ForeignKey("transport_drivers.id"), nullable=True)
    source = Column(String, default="DIRECT_ASSIGNMENT")
...
class TransportTrip(Base):
    ...
    id = Column(String, primary_key=True)
    tenant_id = Column(String, index=True)
    vehicle_id = Column(String, ForeignKey("transport_vehicles.id"), index=True)
    driver_id = Column(String, ForeignKey("transport_drivers.id"), index=True)
    trip_type = Column(String)  # PICKUP / DROP
...
class TransportLocation(Base):
    ...
    id = Column(String, primary_key=True)
    tenant_id = Column(String, index=True)
    trip_id = Column(String, ForeignKey("transport_trips.id"), index=True)
    vehicle_id = Column(String, ForeignKey("transport_vehicles.id"), index=True)
    driver_id = Column(String, ForeignKey("transport_drivers.id"), index=True)

...
export function Modal({ title, children, onClose, footer, className = '' }:
  ...
  return (
    <div className="modal-bg" onClick={onClose}>
      <div className={`modal ${className} ${title.startsWith('Affected Students') ? 'affected-students-modal' : ''} ${title === 'Programme proposal review' ? 'program-review-modal' : ''}`.trim()} onClick={e => e.stopPropagation()}>

...
const FACULTY_NAV = [
  ...
  ['Teaching & Academics', 'Attendance', 'attendance'],
...
const FACULTY_ACTIVE_LABEL: Record<string, string> = {
  ...
  academics: 'Assessments', attendance: 'Attendance', assessments: 'Assessments', marks_entry: 'Marks Entry', examinations: 'Examinations',
